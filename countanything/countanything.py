...
from feature_extractor import SemanticRichEncoder
...
class SamAutomaticMaskGenerator:
    def __init__(
        ...
        semantic_encoder_checkpoint = 'facebook/dinov2-base'
        self.dinov2 = SemanticRichEncoder(semantic_encoder_checkpoint)  
    ...
    def _process_crop(
        ...
        if len(ref_box) > 0:
            ...
            feature,_ = self.dinov2.extract_features(cropped_im)
            ...
            print("feat: ",feature.device)  # Output: "cpu"
            print("mask: ",masks_low_res.device)  # Output: "cuda:0"
    ...
    def _process_batch(
        ...
        crop_box: List[int],
        orig_size: Tuple[int, ...],
        image: np.ndarray,  # Add this parameter
    ) -> MaskData:
        ...
        # Use the cropped image for feature extraction
        x0, y0, x1, y1 = crop_box
        cropped_im = image[y0:y1, x0:x1, :]
        
        # Convert numpy array to PIL Image
        cropped_im_pil = Image.fromarray(cropped_im)
        
        # Extract features using DINOv2
        feature, _ = self.dinov2.extract_features(cropped_im_pil)
        feature = feature.to("cuda")
